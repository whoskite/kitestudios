...
export default function AccessDeniedPage() {
  ...
  return (
    <div className="page-wrapper" data-oid="ce4:dtb">
      <OffWhiteNav data-oid="7ng1vbu" />
      <div
        className="min-h-screen bg-white dark:bg-black off-white-grid flex items-center justify-center py-20"
        data-oid="6o9wik7"
      >
        <div className="container mx-auto px-4" data-oid="k6h1:kb">
          <motion.div
          ...
          >
            ...
            >
              <div
                className="absolute -top-3 -right-3 bg-[#ffff00] p-1 text-black z-10"
                data-oid="l7sdq0f"
              >
                <span
              ...
              <div className="flex justify-center mb-6" data-oid="uyw1wda">
                <motion.div
              ...
              <h1
                className="text-2xl font-bold mb-2 text-center industrial-text"
                data-oid="rnrp3r6"
              >
                RESOURCE HUB
              </h1>
              <div
                className="w-12 h-1 bg-black dark:bg-white mx-auto mb-6"
                data-oid="z:r4.yx"
              ></div>

              <p className="mb-8 text-center" data-oid="fpqm88n">
                Sign in to access exclusive KITESTUDIOS resources, tools, and
                content.
              </p>
              ...
              >
                <motion.div
                  ...
                  data-oid="jc-lkmi"
                />
                <LogIn className="mr-2 h-5 w-5" data-oid="8vuz60b" /> SIGN IN
                WITH GOOGLE
              </motion.button>
            ...
            <div className="mt-8 flex justify-center" data-oid="9i90aoo">
              <div
                className="off-white-label px-3 py-1 text-xs font-bold uppercase"
                data-oid=".:ull.0"
              >
