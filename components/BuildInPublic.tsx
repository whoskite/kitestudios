...
export default function BuildInPublic() {
  ...
  useEffect(() => {
    if (
      ...
      projects[selectedUpdate.projectIndex].updates[selectedUpdate.updateIndex]
      ...
      if (randomizedPositions.length === 0) {
        ...
        const positions = Array.from(
          {
            length:
              projects[selectedUpdate.projectIndex].updates[
                selectedUpdate.updateIndex
  ...
  const updateNotePosition = (index: number, info: any) => {
    ...
    const constrainedX = Math.max(
      padding,
      Math.min(containerWidth - noteWidth - padding, relativeX),
    );
    const constrainedY = Math.max(
      padding,
      Math.min(containerHeight - noteHeight - padding, relativeY),
    );
  ...
  const projectsData: Project[] = [
    {
      ...
      completion: 50,
      description:
        "The official website and digital presence for KITESTUDIOS, showcasing our projects, philosophy, and creative approach to building in public.",
      url: {
      ...
      updates: [
        {
          ...
          content:
            "Launched the initial version of the KITESTUDIOS website, establishing our digital presence and brand identity.",
          detailedContent: `
        ...
        },
        {
          ...
          title: "The Library",
          content:
            "Currently building The Library section to showcase our collection of resources, inspirations, and creative references.",
        },
      ],
      ...
      icon: (
        <Construction
          size={24}
          className="text-black dark:text-[#ffff00]"
          data-oid="tr7okv2"
        />
      ),
    },
    {
      ...
      completion: 75,
      description:
        "A modern quote generator app that delivers inspirational, funny, and thought-provoking quotes with GIF integration, powered by AI and enhanced with social sharing capabilities.",
      url: {
      ...
      updates: [
        {
          ...
          content:
            "Refreshed the user interface for quote categories with improved visual hierarchy and interaction patterns.",
        },
        {
          date: "FEBRUARY 14, 2025",
          title: "COMMUNITY'S FIRST OFFICIAL EVENT",
          content:
            "Launched the first official community event centered around /funquotes, engaging users in collaborative quote creation.",
        },
        {
          date: "DECEMBER 2024",
          title: "STARTED BUILDING FUNQUOTES",
          content:
            "Initiated development of the FunQuotes project, establishing the foundation for the quote generation platform.",
        },
      ],
    ...
    },
    {
      ...
      completion: 100,
      description:
        "A powerful bulk file renaming application designed to streamline workflow for photographers, designers, and content creators with intuitive batch processing capabilities.",
      url: {
      ...
      updates: [
        {
          ...
          content:
            "Successfully released the Snap Rename application, providing users with a robust solution for efficiently organizing and renaming large collections of files.",
        },
      ],
    ...
    },
    {
      ...
      completion: 10,
      description:
        "An immersive community-driven storytelling platform that expands the Crypto Junkie Social Club lore through interactive chapters and community voting on narrative decisions. The project combines web3 elements with collaborative worldbuilding.",
      updates: [
        {
          date: "APRIL 2025",
          title: "WEB APPLICATION",
          content:
            "Developing an interactive web platform where community members can explore the evolving lore of Crypto Junkies, participate in story decisions, and contribute to the expanding narrative universe.",
        },
      ],
    ...
    },
    {
      ...
      completion: 40,
      description:
        "A playful crypto project featuring a lovable canine mascot, offering unique tokenomics and community-driven development with a focus on accessibility.",
      url: {
      ...
      updates: [
        {
          ...
          content:
            "Successfully implemented token swapping functionality, allowing users to easily exchange Don tokens with other cryptocurrencies.",
        },
      ],
    ...
    },
    {
      ...
      completion: 25,
      description:
        "A high-end streetwear brand by gLYF, blending contemporary fashion with artistic expression through limited edition collections and cultural collaborations.",
      url: {
      ...
      updates: [
        {
          ...
          title: "SMELL THE FLOWERS COLLECTION DROP",
          content:
            "Successfully launched our spring-themed streetwear collection featuring floral motifs and sustainable materials across a range of premium garments.",
          postItNotes: [
            {
              content:
                "Design inspiration came from Tokyo's cherry blossom season. The pink tones really pop against the black base.",
            ...
            {
              content:
                "Fabric samples arrived late but the quality was worth the wait. 100% organic cotton feels amazing.",
              color: "#ccffcc", // Light green
              rotation: 2,
            },
            {
              content:
                "Production team crushed it! Completed the entire run in just 3 weeks despite supply chain issues.",
              color: "#ffffcc", // Light yellow
              rotation: -2,
            },
            {
              content:
                "Photoshoot location scouting paid off. The botanical garden backdrop perfectly complemented the collection theme.",
            ...
            {
              content:
                "Marketing campaign generated 3x more pre-orders than our winter collection. Social engagement up 47%!",
        ...
        },
        {
          ...
          content:
            "Completed the inaugural Gallery 82 branded photoshoot, establishing our visual identity and showcasing our distinctive streetwear aesthetic.",
        },
      ],
  ...
  const insights = [
    {
      ...
      content:
        "Building in public means showing the messy middle. The unfinished work often sparks the most valuable conversations.",
      icon: (
        <Lightbulb
          size={20}
          className="text-black dark:text-[#ffff00]"
    ...
    },
    {
      ...
      content:
        "The process is as valuable as the outcome. Capture your thinking, iterations, and decision points along the way.",
      icon: (
        <Pencil
          size={20}
          className="text-black dark:text-[#ffff00]"
    ...
    },
    {
      ...
      content:
        "Open building creates opportunities for unexpected collaborations. Be open to input that might redirect your work.",
      icon: (
        <GitBranch
          size={20}
          className="text-black dark:text-[#ffff00]"
  ...
  return (
    <section
      className="py-20 bg-white dark:bg-black off-white-stripes"
      data-oid="vr-k3kl"
    >
      <div className="container mx-auto px-4" data-oid="qma6v99">
        {/* Header */}
        <div className="mb-16 relative" data-oid="jcwag:_">
          <motion.h2
          ...
          <motion.p
            ...
            data-oid="jaywq:s"
          >
            At KITESTUDIOS, we believe in the power of building in the open.
            Here, we share our works-in-progress, document our process, and
            invite conversation around our creative journey.
          </motion.p>
        </div>
        ...
        >
          ...
          <div className="lg:col-span-1" data-oid="k05:7-.">
            <div
              className="border-2 border-black dark:border-white p-4 mb-6"
              data-oid="5kmh-jy"
            >
              <h3
                className="industrial-text text-xl mb-4 off-white-quote"
                data-oid="gtid-re"
              >
                ACTIVE BUILDS
              </h3>

              <div className="space-y-4" data-oid="uf.e889">
                {projects.map((project, index) => (
                  ...
                  >
                    ...
                    >
                      <div data-oid="zjo1vjj">
                        ...
                        >
                          ...
                          <span data-oid="75lr9n0">{project.lastUpdate}</span>
                        </div>
                      </div>
                      <div
                    ...
                    {/* Progress Bar */}
                    <div
                      className="mt-3 h-1 w-full bg-gray-200 dark:bg-gray-700"
                      data-oid=":u1wmk5"
                    >
                      <div
            ...
            >
              ...
              <div className="space-y-4" data-oid="bshx_pt">
                {insights.map((insight, index) => (
                  <motion.div
                    ...
                    data-oid="ny1m-wn"
                  >
                    <div className="flex items-center mb-1" data-oid="itur2kq">
                      {insight.icon}
                      <h4 className="font-bold text-sm ml-2" data-oid="_3gl885">
                        {insight.title}
                      </h4>
                    </div>
                    <p className="text-xs" data-oid=".u90-rt">
                      {insight.content}
                    </p>
                  </motion.div>
                ))}
          ...
          <div className="lg:col-span-2" data-oid="flc7zov">
            <motion.div
            ...
            >
              {/* Project Header */}
              <div
                className="p-6 border-b-2 border-black dark:border-white relative"
                data-oid="61bavb:"
              >
                <div
                ...
                <h3
                  className="industrial-text text-2xl mb-2 mt-2"
                  data-oid="j._aydv"
                >
                  {projects[activeProject].title}
                </h3>
                <p className="mb-4" data-oid="26iq9hm">
                  {projects[activeProject].description}
                </p>

                {projects[activeProject].url && (
                  <div className="mb-4" data-oid="wi:qvvy">
                ...
                <div className="flex flex-wrap" data-oid="am3l6c.">
              ...
              {/* Project Updates */}
              <div className="p-6" data-oid="ukpmvaj">
                <div className="flex items-center mb-6" data-oid="hu35g8w">
                  <h4 className="text-lg font-bold mr-4" data-oid="u1x0q1r">
                    BUILD UPDATES
                  </h4>
                  <div
                    className="h-0.5 bg-black dark:bg-white flex-grow"
                    data-oid="tnason4"
                  ></div>
                </div>

                <div className="space-y-8" data-oid="0ixe4d4">
                  {projects[activeProject].updates.map((update, index) => (
                    ...
                    >
                      <div
                        className="absolute -left-3 top-0 w-6 h-6 bg-[#ffff00] flex items-center justify-center rounded-full text-black"
                        data-oid="dhszrx3"
                      >
                        <Hammer size={14} data-oid="yw8coe_" />
                      </div>

                      <div
                        className="bg-[#ffff00] text-black text-xs font-bold px-2 py-1 inline-block mb-2"
                        data-oid="4fadxgh"
                      >
                        {update.date}
                      </div>

                      <h5 className="font-bold mb-2" data-oid="k9ofm10">
                        {update.title}
                      </h5>
                      <p className="text-sm mb-4" data-oid="ym.-1jk">
                        {update.content}
                      </p>
                      ...
                      >
                        <button
                          ...
                          data-oid="wesqy1."
                        >
                          <Eye size={14} className="mr-1" data-oid="axre::y" />
                          VIEW DETAILS
                        </button>
                        <button
                          className="flex items-center hover:text-[#ffff00] transition-colors"
              ...
              {/* Call to Action */}
              <div
                className="p-6 border-t-2 border-black dark:border-white bg-black dark:bg-white text-white dark:text-black"
                data-oid="-5mvz._"
              >
                <div
                  ...
                  data-oid="lqtj-is"
                >
                  <div data-oid="djr4_pr">
                    <h4 className="font-bold mb-1" data-oid="87i5u:5">
                      FOLLOW THIS BUILD
                    </h4>
                    <p className="text-sm" data-oid=":714ofo">
                      Get updates as this project evolves and join the
                      conversation.
                    </p>
                  </div>

                  <div className="mt-4 md:mt-0" data-oid="tp4cx0p">
                    <button
                      className="bg-[#ffff00] border-2 border-white dark:border-black px-4 py-2 text-black font-bold uppercase tracking-wider flex items-center"
                      data-oid="2n.evch"
                    >
                      SUBSCRIBE
                      <ArrowUpRight
        ...
        >
          ...
          {projects[selectedUpdate.projectIndex].title === "GALLERY 82" &&
            ...
            projects[selectedUpdate.projectIndex].updates[
              ...
              <div
                ...
                data-oid="bcmoas4"
              >
                <div className="w-full h-full relative" data-oid="7v.peol">
                  {projects[selectedUpdate.projectIndex].updates[
                    selectedUpdate.updateIndex
                  ].postItNotes!.map((note, idx) => {
                    const position =
                      randomizedPositions[idx] || getRandomPosition();
          ...
          >
            ...
            >
              ...
              <h3 className="industrial-text text-2xl mb-4" data-oid="dcv4pzw">
                {
                  projects[selectedUpdate.projectIndex].updates[
                    selectedUpdate.updateIndex
                  ].title
              ...
              <div className="flex items-center mb-4" data-oid="-xrzd9r">
                <div
                  className="w-6 h-6 bg-white dark:bg-black p-1 border-2 border-black dark:border-white rounded-full mr-2 flex items-center justify-center"
                  data-oid="4.:c2p8"
                >
                  {projects[selectedUpdate.projectIndex].icon}
                </div>
                <span className="font-bold" data-oid="eahbgu9">
                  {projects[selectedUpdate.projectIndex].title}
                </span>
              </div>
            </div>

            <div className="p-6" data-oid="svn2ad-">
              <div
                className="prose dark:prose-invert max-w-none"
                data-oid="8id1dcn"
              >
                <p className="mb-6" data-oid="2c8:my.">
                  {
                    projects[selectedUpdate.projectIndex].updates[
                      selectedUpdate.updateIndex
                    ].content
                ...
                {!projects[selectedUpdate.projectIndex].updates[
                  ...
                  <div
                    className="border-l-4 border-[#ffff00] pl-4 py-2 my-4 italic"
                    data-oid="vq94vcy"
                  >
                    More detailed information about this update will be
                    available soon.
                  </div>
                )}
              </div>
              ...
              {projects[selectedUpdate.projectIndex].updates[
                ...
                projects[selectedUpdate.projectIndex].updates[
                  ...
                  <div className="mt-8" data-oid="kkja.u1">
                    <h4 className="text-lg font-bold mb-4" data-oid="tatoq6w">
                      Images
                    </h4>
                    <div className="grid grid-cols-2 gap-4" data-oid="85id2-5">
                      {projects[selectedUpdate.projectIndex].updates[
                        selectedUpdate.updateIndex
                      ].images!.map((image: UpdateImage, idx: number) => (
                        <div
                          key={idx}
            ...
            >
              ...
              >
                ...
                <button
                  className="flex items-center text-white dark:text-black hover:text-[#ffff00] dark:hover:text-[#ffff00] transition-colors text-sm"
                  data-oid="uokmpt3"
                >
                  <MessageCircle
                    size={14}
